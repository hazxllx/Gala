...
import 'package:my_project/cafe.dart'; 
        ...
        actions: [
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/user.png'), // unaffected by dark mode
            ),
          ),
        ],
      ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    TextButton(
                      onPressed: () {},
                      child: const Text("Sort by", style: TextStyle(color: Colors.blue)),
                    ),
                  ],
                ),
              ],
